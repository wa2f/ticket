...
<head>
    @include('components.attendee.layout.head')
</head>

<body>
    <section>
        <div class="header_main_home font-white">
            <div class="">
                <center>
                    ...
                    <div>
                        <a class="text-decoration-non" href="{{ url('/checkoutdetails') }}">checkout details</a>
                    </div>
                </center>
            ...
            <div>
                <center>
                    <p>Please click on the message icon to add the requred details</p>
                </center>
            </div>
        </div>
    </section>
                ...
                <div class="formbold-form-wrapper">
                    ...
                    <form action="#!" method="POST" class="formbold-chatbox-form">
                        ...
                        <div class="formbold-mb-5">
                            ...
                            <input type="email" name="email" id="email" placeholder="example@name.com"
                                class="formbold-form-input" />
                        </div>

                        <div class="formbold-mb-5">
                            <label for="message" class="formbold-form-label"> Message </label>
                            <input type="tel" name="phone_number" id="tel" placeholder="+254 711 111 111"
                                class="formbold-form-input" />
                        </div>
